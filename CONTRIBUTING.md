...
1. Fork the `https://github.com/chris1ding1/masonite-lang` repo.
2. Clone that repo into your computer: `git clone http://github.com/your-username/lang.git`.
3. Checkout the current release branch \(example: `master`\).
4. Run `git pull origin master` to get the current release version.

### Install the environment

1. You should create a Python virtual environment with `Python >= 3.11`.
...
- When making changes to your packages you will need to uninstall the package and reinstall it with
  `pip uninstall lang && pip install .`
